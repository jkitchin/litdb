...
[[./screenshots/date-08-12-2024-time-08-32-26.png]]
...
It is not that easy to just switch models; you would need to either add new columns and compute embeddings for everything, or update all the embeddings for a new model.
